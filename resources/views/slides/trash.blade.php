...
@section('content')
    ...
    @elseif ($id == 4)
        <div class="alert alert-primary hed" role="alert">
            ...
            <p style="margin: 0px;">FAQ Trash</p>
    ...
    @elseif ($id == 6)
        <div class="alert alert-primary hed" role="alert">
            ...
            <p style="margin: 0px;">Customer opinions Trash</p>
    ...
    @elseif ($id == 7)
        <div class="alert alert-primary hed" role="alert">
            ...
            <p style="margin: 0px;">blog Trash</p>
    ...
    @elseif ($id == 8)
        <div class="alert alert-primary hed" role="alert">
            ...
            <p style="margin: 0px;">services Trash</p>
    ...
    @elseif ($id == 9)
        <div class="alert alert-primary hed" role="alert">
            ...
            <p style="margin: 0px;">why bahaa? Trash</p>
