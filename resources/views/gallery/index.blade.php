...
@section('content')
    ...
    @if ($id == 1)
        <div class="alert alert-primary hed" role="alert">
            ...
            <a href="{{ url('slides/trash/1') }}">
                <i class="fa-regular fa-trash-can"></i>
            </a>


            <p style="margin: 0px;">Slide</p>
    ...
    @elseif ($id == 2)
        <div class="alert alert-secondary hed" role="alert">
            <a href="{{ url('gallery/trash/2') }}">
                <i class="fa-regular fa-trash-can"></i>
            </a>


            <p style="margin: 0px;">Gallery</p>
    ...
    @elseif ($id == 3)
        <div class="alert alert-secondary hed" role="alert">
            <a href="{{ url('gallery/trash/3') }}">
                <i class="fa-regular fa-trash-can"></i>
            </a>


            <p style="margin: 0px;"> Our Group</p>
    ...
    @elseif ($id == 5)
        <div class="alert alert-secondary hed" role="alert">
            <a href="{{ url('gallery/trash/5') }}">
                <i class="fa-regular fa-trash-can"></i>
            </a>


            <p style="margin: 0px;"> video</p>
                                ...
                                <div class="card-body">
                                    <form class="frm" action="{{ route('slides.update', $slid->id) }}" method="POST"
                                        ...
                                        <div class="img-container"
                                            ...
                                            @php
                                                $isVideo = preg_match('/\.(mp4|webm|ogg)$/i', $slid->img); // التحقق من الامتداد
                                            @endphp

                                            @if ($isVideo)
                                                <video controls class="card-img-top" id="uploadVideo{{ $slid->id }}">
                                                    <source src="{{ asset('../../bahaa/public/storage/' . $slid->img) }}"
                                                        type="video/mp4">
