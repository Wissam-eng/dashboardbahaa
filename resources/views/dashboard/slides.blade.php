                            ...
                            @if ($type_page == 'untrashed')
                                <div class="card-header">
                                    {{-- <form id="delete-form-{{ $slid->id }}"
                                        action="{{ route('dashboard.slides.delete', $slid->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="card-body">
                                    <form action="{{ route('dashboard.slides.update', $slid->id) }}" method="POST"
                                        ...
                                        <div class="img-container"
                                            ...
                                            <img src="{{ asset('storage/' . $slid->img) }}" class="card-img-top"
                                                alt="..." id="uploadImage{{ $slid->id }}">
                                        </div>
                            ...
                            @elseif ($type_page == 'trashed')
                                <div class="card-header">
                                    <a class="btn btn-danger btn-sm"
                                        href="{{ route('dashboard.slides.restore', $slid->id) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <br>
                                            ...
                                            <form action="{{ route('dashboard.slides.destroy', $id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
